...
Define una función incrementarPrecio, que recibe como parámetros una estructura str_Libro, y un float incr, y devuelve una nueva str_Libro con el mismo contenido pero su precio incrementado incr.
